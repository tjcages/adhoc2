...
import MessageContent from "../content/message-content/MessageContent";
...
import {
  ...
  clearPageTokens,
  setSearchQuery
} from "../content/actions/message-list.actions";
        ...
        render={props => {          
          ...
          return (
            <MessageList
              ...
              pageTokens={this.props.pageTokens}
              addInitialPageToken={this.addInitialPageToken}
              parentLabel={that.props.labelsResult.labels.find(el => true )}
              searchQuery={this.props.searchQuery}
            />
          )
        }}
