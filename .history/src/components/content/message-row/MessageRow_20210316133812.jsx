  ...
  render() {
    ...
    return (
      ...
      <div className={`inbox-container ${this.state.selected}`} onClick={this.messageSelected}>
        ...
        <div className={this.state.selected ? 'inbox-options selected' : 'inbox-options'}>
            <HiOutlineDotsHorizontal className="inbox-icon" />
        </div>
      </div>


      <div className={`d-flex table-row-wrapper${this.state.selected}`}>
        {/* <MesssageCheckbox
